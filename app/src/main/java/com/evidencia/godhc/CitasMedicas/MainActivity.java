    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(view, "No hay mensajes nuevos", Snackbar.LENGTH_LONG)
        ...
        btn_pacientes = (Button) findViewById(R.id.btn_pacientes);
        btn_recetas = (Button) findViewById(R.id.btn_recteas);

        btn_citas.setOnClickListener(this);
        btn_pacientes.setOnClickListener(this);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btn_citas:
                goToSecondActivity();
                break;
            case R.id.btn_pacientes:
                Intent intent = new Intent(this, Pacientes.class);
                startActivity(intent);
                break;
            case R.id.btn_recteas:
                Intent intent2 = new Intent(this, Recetas.class);
